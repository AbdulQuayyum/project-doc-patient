...
const Sidebar = () => {
    ...
    const activeLink = "flex items-center px-4 py-2 my-2 text-[#000] border-l-4 border-[#000] transition-all duration-500 bg-[#e5e7eb] rounded-r-full dark:bg-gray-700 dark:text-gray-200";
    const normalLink = "flex items-center px-4 py-2 my-2 text-gray-400 transition-all duration-500 transform rounded-md dark:text-gray-400 hover:bg-[$F4F4F5] hover:text-black dark:hover:bg-gray-700 dark:hover:text-gray-200";
